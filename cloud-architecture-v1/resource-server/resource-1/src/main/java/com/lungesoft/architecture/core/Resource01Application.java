...
public class Resource01Application {

    private static final Logger log = LoggerFactory.getLogger(Resource01Application.class);

    public static void main(final String[] args) {
        SpringApplication.run(Resource01Application.class, args);
    }
